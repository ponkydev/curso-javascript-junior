/* -- Bucles e Iteraciones: permiten la repetición eficiente de un bloque de código. Facilitan la ejecución de tareas repetitivas y 
el procesamiento de datos en programas.

- while (Se repetira hasta que la condicion deje de cumplirse) */
let numParaWhile = 0;
...
- do while (Se diferencia del while ya que este primero realiza la accion y luego pregunta la condicion) */
do {
    numParaWhile++;
}
...
- break (Hace que el bucle termine sin importar si la condicion sigue siendo verdadera) */
...
- for (Se diferencia del while ya que es determinado, le podemos asignar cuantas veces se repetira, el while se ejecuta mientras
...
/*
- continue (Sirve para saltarnos una accion en el bucle) */
for (let i = 0; i < 10; i++) {
    if (i == 5) {
        continue
    }
...
- for in (Nos devuelve la posicion de un valor dentro de un array) */
...
- for of (Nos devuelve los valores dentro de un array) */
for (let animal of animales) {
    return animal;
} /* Nos retornara ("perro", "gato", "largarto"), ya iterado, osea fuera del array.

- label (Sirve para nombrar bucles, esto nos sirve para poder saltarnos bucles completos o romper el flujo con un break) */
