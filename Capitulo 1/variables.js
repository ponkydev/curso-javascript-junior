/* -- Variables: Guarda un espacio en memoria para un valor cambiante.
...
- Scope
Alcance que se le permite a una variable.

- Scope de Variables (Se debe de colocar antes de crear la variable)
